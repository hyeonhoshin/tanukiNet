...
def generate_model(input_shape, pool_size, weight_decay=0.):
    ...
    # Block 2
    x = Conv2D(64, (3, 3), activation='relu', padding='same', name='block2_conv1', kernel_regularizer=l2(weight_decay))(x)
    ...
    x = Dropout(0.5)(x)
    x = Conv2D(1024, (1, 1), activation='relu', padding='same', dilation_rate=(2, 2), name='fc2', kernel_regularizer=l2(weight_decay))(x)
    x = Dropout(0.5)(x)
    #classifying layer
