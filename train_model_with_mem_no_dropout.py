...
# Model generation
model = tanuki_ml.generate_model_without_Dropout(input_shape, pool_size)
...
# Weights 저장
model.save_weights("mem_is_{}_no_dropout.h5".format(memory_size))
print("Saved model to disk")

# Model 구조 저장
model_json = model.to_json()
with open("model_structure_when_mem_is_{}_no_dropout.json".format(memory_size), "w") as json_file :
    json_file.write(model_json)

## 실험 데이터 저장
f=open("train_result_mem_is_{}_no_dropout.txt".format(memory_size),'w')
